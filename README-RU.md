# tModLoader, API для модов на Terraria 

## Язык

**```Русский```** | [```English```](README.md)

tModLoader (TML) - это open-source модификация для Terraria, позволяющая создавать и играть в моды. TML расширияет ваши приключения в Terraria с помощью нового контента, созданного коммьюнити Terraria! TML позволяет создавать и играть в моды на Terraria в одиночку и с друзьями, с одним или нескольками модами: играйте, как вам хочется! Учтите, что всем вашим друзьям нужно установить TML, если вы хотите играть вместе; игроки из ванильной игры не могут играть с игроками TML.
